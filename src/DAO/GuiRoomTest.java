...
public class GuiRoomTest extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GuiRoomTest frame = new GuiRoomTest();
	...
	public GuiRoomTest() {
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				dispose();
				GuiRegistrationRentRoomTest r = new GuiRegistrationRentRoomTest();
				r.setVisible(true);
